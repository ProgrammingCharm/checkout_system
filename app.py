...
from dml import get_all_available_items, add_item
...
def index():
    return render_template('index.html', available_items=get_all_available_items())
...
def add_item_manually():
    ...
    add_item(item_name, item_description)
    return render_template('register.html')
